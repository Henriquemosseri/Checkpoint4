...
namespace performance_cache.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            await db.KeyExpireAsync(key, TimeSpan.FromMinutes(15)); //definindo o tempo que ele vai durar e a key do db
            ...
            string sql = "select id, name, email,ultimoAcesso from users; "; //Fazendo o mock da requisição SQL
